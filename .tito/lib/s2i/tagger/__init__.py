"""
Code for tagging source-to-image packages
"""
...
class S2ITagger(VersionTagger):
    """
    s2i custom tagger. This tagger has several deviations from normal
...
class S2IForceVersionTagger(S2ITagger):
    """
